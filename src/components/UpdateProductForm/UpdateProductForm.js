...
import {updateProduct} from "../../store/slices";
import {useParams} from "react-router-dom";

export const UpdateProductForm = ({setShowUpdateProduct}) => {
    ...
    return (
        <div className="addProductForm">
            <div className="addProductFormOverlay" onClick={() => setShowUpdateProduct()}/>
            <div className="modalContent">
                ...
                <form onSubmit={formik.handleSubmit}>
                    <div className="addProductFormInputs">
                        ...
                        />
                        <div>
                            <Button onClick={() => setShowUpdateProduct()} style={{margin: "5px"}} variant="outlined" color="secondary">Cancel</Button>
                            <Button disabled={isDisabledButton} type="submit" variant="outlined">
                                Update
                            </Button>
                        </div>
                    </div>
